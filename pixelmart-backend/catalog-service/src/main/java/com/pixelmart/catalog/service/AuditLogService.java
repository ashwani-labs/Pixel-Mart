...
public class AuditLogService {
  ...
  @Transactional
  public void log(
      String action, String entityType, String entityId, Object oldValue, Object newValue) {
    auditLogRepository.save(
        AuditLog.of(
            currentActorId(), action, entityType, entityId, toJson(oldValue), toJson(newValue)));
  }
