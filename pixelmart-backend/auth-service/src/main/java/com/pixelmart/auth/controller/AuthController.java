...
public class AuthController {
  ...
  private AuthResponse writeTokens(
      com.pixelmart.auth.dto.AuthTokens tokens, HttpServletResponse response) {
    refreshCookieService.writeRefreshCookie(
        response, tokens.refreshToken(), refreshTokenService.refreshExpirationSeconds());
    return tokens.auth();
  }
}
